 ...
 * Широта находится в диапазоне от -90 до 90 градусов. Реализовать арифметические операции сложения,
...
class Position {
    private:
        ...
        double longitude;
    public:
    Position(double lhs, double rhs) : latitude(lhs), longitude(rhs) {}; //инициализация конструктора
